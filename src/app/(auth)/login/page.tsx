        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-warm-white p-4">
            <div className="w-full max-w-md rounded-xl bg-white p-8 shadow-lg">
                ...
                <div className="mt-4 flex flex-col items-center gap-2 text-sm text-gray-600">
                    <p>
                        New Student?{" "}
                        <Link href="/student-signup" className="text-coffee-dark underline font-semibold">
                            Student Signup
                        </Link>
                    </p>
                    <p>
                        New Faculty?{" "}
                        <Link href="/faculty-signup" className="text-coffee-dark underline font-semibold">
                            Faculty Signup
                        </Link>
                    </p>
                </div>
